...
courseRouter.get("/get-admin-courses", user_controller_1.updateAccessToken, auth_1.isAuthenticated, (0, auth_1.authorizeRoles)("admin"), course_controller_1.getAllCourse);
courseRouter.post('/getVdoCipherOTP', course_controller_1.generateVideoUrl);
courseRouter.delete("/delete-courses/:id", user_controller_1.updateAccessToken, auth_1.isAuthenticated, (0, auth_1.authorizeRoles)("admin"), course_controller_1.deleteCourse);
