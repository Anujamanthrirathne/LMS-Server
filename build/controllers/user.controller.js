...
exports.registrationUser = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        const activationToken = (0, exports.createActivationToken)(tempUserData);
...
exports.activateUser = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        const newUserPayload = jsonwebtoken_1.default.verify(activation_token, process.env.ACTIVATION_SECRET);
...
exports.logoutUser = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        if (userId && typeof userId === "string" && userId.trim() !== "") {
            await redis_1.redis.del(userId); // Delete from Redis only if userId is a valid string
        }
        else {
...
exports.updatePassword = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        await user.save();
        const userId = req.user?._id; // Type assertion
        await redis_1.redis.set(userId, JSON.stringify(user));
        res.status(201).json({
            success: true,
            user,
